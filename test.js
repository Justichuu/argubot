...
test('the html page can sit on chuumind.com', () => {
  ...
  assert.match(html, /Box is the page\. Biggest\. Stamp is the red thing\. Face is the film\. Off unless you want them\./);
  assert.match(html, /You do not need these\. Box is the page\. Stamp is the red thing\. Face is the film\./);
  assert.match(html, />Box<\/button>/);
  assert.match(html, />Stamp<\/button>/);
  assert.match(html, />Face<\/button>/);
  assert.match(html, /#argue \{[^}]*linear-gradient/);
  assert.match(html, /#yes \{[^}]*--mint/);
...
test('there is one demo', () => {
  ...
  assert.match(readme, /Box is on\. Stamp and Face are in options\. Off\./);
