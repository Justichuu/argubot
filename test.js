...
test('the html page can sit on chuumind.com', () => {
  ...
  assert.match(html, /Nothing is sent\. Close the tab and it's gone\./);
  ...
  assert.match(html, /This is a letter\. Box is biggest\. Stamp is the red thing\. Face is the film\./);
  ...
  assert.doesNotMatch(html, /html\.full \.sign/);
...
test('there is one demo', () => {
  ...
  assert.match(readme, /this is a letter\. Stamp and Face are in options\. Off\./);
